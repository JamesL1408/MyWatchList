...
function MovieCardSquare({Img,Title,Desc,Stars,Company,Date,Id}) {
  ...
  return (
    <div onClick={()=>{
        ...
        }} className='h-[140px] w-[140px] 600pix:h-[200px] 600pix:w-[200px] relative rounded-md cursor-pointer group z-20 shadow-sm shadow-gray-500 '>
        ...
        <div className='absolute bottom-0 opacity-0 left-0 w-full h-full group-hover:opacity-100 transition-all duration-300 ease-in-out flex flex-col px-3 py-3  rounded-md bg-transparent z-30 text-white items-center justify-start'>
            ...
            className='absolute bottom-3  text-black px-2 bg-green-500 z-50 rounded-md font-medium hover:brightness-110 flex space-x-1'>
