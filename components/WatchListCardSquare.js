...
function WatchListCardSquare({Img,Title,Duration,Stars,Id,Company,Date}) {
  ...
  return ( 
    <>
      ...
      <div className='h-[140px] w-[140px] 600pix:h-[200px]  600pix:w-[200px] relative  rounded-md cursor-pointer  group'>
